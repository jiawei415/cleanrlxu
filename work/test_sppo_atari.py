...
if ckpt:
    if ':' in ckpt:
        ckpt_load_path = f"results/{game_name}_sppo_{ckpt.split(':')[0]}/checkpoints/ckpt_{ckpt.split(':')[1]}.pkl"
    else:
        ckpt_load_path = f"results/{game_name}_sppo_{ckpt}/checkpoints/best_ckpt.pkl"
